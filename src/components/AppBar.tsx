            ...
            <ul tabIndex={0} className="p-2 shadow menu dropdown-content bg-base-100 rounded-box w-52">
              ...
              <li>
                <a>Setting 3</a>
							...
							{process.env.NEXT_PUBLIC_CLUSTER === "MAINNET" &&	<span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-yellow-100 text-yellow-800">Mainnet</span>}
