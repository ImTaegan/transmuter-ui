			...
			<div className={`p-4`}>
				<div className={`flex items-center`}>
					...
					<div className={`ml-2 w-0 flex-1`}>
						...
						{txid ? (
							<div className="flex flex-row">
								...
								<a href={"https://explorer.solana.com/tx/" + txid + `?cluster=mainnet`} target="_blank" rel="noreferrer" className="flex flex-row link link-accent">
					...
					<div className={`ml-4 flex-shrink-0 self-start flex`}>
						<button onClick={() => onHide()} className={`bg-bkg-2 default-transition rounded-md inline-flex text-fgd-3 hover:text-fgd-4 focus:outline-none`}>
